...
El build se sirve por **bind-mount**, no copiándolo dentro de `app/`:
...
Tiene que dar 1 o más. Con el v1 daba 0.

El nodo VPS `finally` sigue sirviendo el v1: `dist/` no está versionado y ese nodo no lo tiene.
Alinearlo es trabajo pendiente.
